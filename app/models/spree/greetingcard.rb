...
# Greetingcards properties include description, permalink, availability,
...
#
# VARIANTS
# All variants can access the greetingcard properties directly (via reverse delegation).
...
module Spree
  class Greetingcard < Spree::Base
    ...
    has_many :properties, through: :greetingcard_properties
    ...
    accepts_nested_attributes_for :greetingcard_properties, allow_destroy: true, reject_if: lambda { |pp| pp[:property_name].blank? }
    ...
    def property(property_name)
      greetingcard_properties.joins(:property).find_by(spree_properties: { name: property_name }).try(:value)
    end
    ...
    def set_property(property_name, property_value, property_presentation = property_name)
      ActiveRecord::Base.transaction do
        ...
        greetingcard_property = GreetingcardProperty.where(greetingcard: self, property: property).first_or_initialize
        greetingcard_property.value = property_value
        greetingcard_property.save!
      end
    end
    ...
    def add_associations_from_prototype
      if prototype_id && prototype = Spree::Prototype.find_by(id: prototype_id)
        prototype.properties.each do |property|
          greetingcard_properties.create(property: property)
        end
