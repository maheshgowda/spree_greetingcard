Spree::Promotion.class_eval do
    ...
    def blacklisted?(promotable)
      case promotable
      when Spree::LineItem
        !promotable.product.promotionable? || !promotable.greetingcard.promotionable?
      when Spree::Order
        promotable.line_items.any? &&
          [!promotable.line_items.joins(:product).where(spree_products: {promotionable: true}).any? || !promotable.line_items.joins(:greetingcard).where(spree_greetingcards: {promotionable: true}).any?]
      end
    end
