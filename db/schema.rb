...
ActiveRecord::Schema.define(version: 20160425104211) do
  ...
  create_table "spree_greetingcard_option_types", force: :cascade do |t|
    t.integer  "position",        limit: 4
    t.integer  "greetingcard_id", limit: 4
    t.integer  "option_type_id",  limit: 4
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
  end

  add_index "spree_greetingcard_option_types", ["greetingcard_id"], name: "index_spree_greetingcard_option_types_on_greetingcard_id", using: :btree
  add_index "spree_greetingcard_option_types", ["option_type_id"], name: "index_spree_greetingcard_option_types_on_option_type_id", using: :btree
  add_index "spree_greetingcard_option_types", ["position"], name: "index_spree_greetingcard_option_types_on_position", using: :btree

  create_table "spree_greetingcard_promotion_rules", force: :cascade do |t|
    t.integer "greetingcard_id",   limit: 4
    t.integer "promotion_rule_id", limit: 4
  end

  add_index "spree_greetingcard_promotion_rules", ["greetingcard_id"], name: "index_greetingcards_promotion_rules_on_greetingcard_id", using: :btree

  create_table "spree_greetingcard_properties", force: :cascade do |t|
  ...
  add_index "spree_greetingcards", ["tax_category_id"], name: "index_spree_greetingcards_on_tax_category_id", using: :btree
  ...
  add_index "spree_greetingcards_taxons", ["greetingcard_id"], name: "index_spree_greetingcards_taxons_on_greetingcard_id", using: :btree
  add_index "spree_greetingcards_taxons", ["position"], name: "index_spree_greetingcards_taxons_on_position", using: :btree
  add_index "spree_greetingcards_taxons", ["taxon_id"], name: "index_spree_greetingcards_taxons_on_taxon_id", using: :btree
  ...
  add_index "spree_variants", ["greetingcard_id"], name: "index_spree_variants_on_greetingcard_id", using: :btree
